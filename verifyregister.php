...
<link rel="https://api.w.org/" href="http://localhost/ws/wordpress/wp-json/" /><link rel="alternate" type="application/json" href="http://localhost/ws/wordpress/wp-json/wp/v2/pages/85" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://localhost/ws/wordpress/xmlrpc.php?rsd" />
...
<link rel="canonical" href="http://localhost/ws/wordpress/register/" />
<link rel='shortlink' href='http://localhost/ws/wordpress/?p=85' />
<link rel="alternate" type="application/json+oembed" href="http://localhost/ws/wordpress/wp-json/oembed/1.0/embed?url=http%3A%2F%2Flocalhost%2Fws%2Fwordpress%2Fregister%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://localhost/ws/wordpress/wp-json/oembed/1.0/embed?url=http%3A%2F%2Flocalhost%2Fws%2Fwordpress%2Fregister%2F&#038;format=xml" />
		<style type="text/css">
			.um_request_name {
		...
		<a class="navbar-logo" href="http://localhost/ws/wordpress/"><h1>Canvas API</h1></a><p class="site-description">Course Information</p>		</span>
			...
			<!-- Navigation Menu-->
				...
				<nav class="nav-collapse">
					<ul id="primary-menu" class="menu-items"><li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-39" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-39 nav-item"><a title="Home" href="http://localhost/ws/wordpress/" class="nav-link">Home</a></li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-40" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-40 nav-item"><a title="Courses" href="http://localhost/ws/wordpress/about/" class="nav-link">Courses</a></li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-41" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-41 nav-item"><a title="Assignments" href="http://localhost/ws/wordpress/blog/" class="nav-link">Assignments</a></li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-42" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-42 nav-item"><a title="Quizzes/Tests" href="http://localhost/ws/wordpress/contact/" class="nav-link">Quizzes/Tests</a></li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-47" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-47 nav-item"><a title="Announcements" href="http://localhost/ws/wordpress/announcements/" class="nav-link">Announcements</a></li>
</ul>				</nav>
			<!-- End navigation menu-->
...
/* <![CDATA[ */
var um_scripts = {"nonce":"9bb5150808"};
/* ]]> */
</script>
