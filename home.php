		...
		<a class="navbar-logo"><h1>Canvas API</h1></a><p class="site-description">Course Information</p>		</span>
			...
			<!-- Navigation Menu-->
				...
				<nav class="nav-collapse">
					<ul id="primary-menu" class="menu-items"><li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-39" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home active menu-item-39 nav-item"><a title="Home" href="home.php" class="nav-link">Home</a></li>
...
<article id="post-22" class="post post-22 page type-page status-publish hentry">
	...
	<header class="entry-header">
		<h2 class="text-left mt-0 mb-4 text-uppercase"><b>About</b></h2>	</header><!-- .entry-header -->

	
	<div class="blog-detail-description">
		
<p>Welcome to the Canvas API Webpage. In this webpage, you can view your courses, assignments, announcements, and other course information. The purpose of this webpage is to offer similar functionality to what the Canvas UI currently offers but with increased functionality and more accessibility. In order to use this webpage, you will need to create and use an API token that you can get directly from your Canvas profile. The instructions will be listed down below.</p>



<h2 class="has-text-align-left has-very-dark-gray-color has-text-color">How to Get or Change Your Token</h2>
...
<figure class="wp-block-image size-large"><img loading="lazy" width="560" height="577" src="../ws/wordpress/wp-content/uploads/2021/03/Account_Screenshot.png" alt="" class="wp-image-50" srcset="../ws/wordpress/wp-content/uploads/2021/03/Account_Screenshot.png 560w, ../ws/wordpress/wp-content/uploads/2021/03/Account_Screenshot-291x300.png 291w" sizes="(max-width: 560px) 100vw, 560px" /></figure>



<p>Next, in the &#8220;Settings&#8221; page, locate the section called &#8220;Approved Integrations&#8221; and click on the &#8220;+ New Access Token&#8221; button.</p>



<figure class="wp-block-image size-large"><img loading="lazy" width="255" height="67" src="../ws/wordpress/wp-content/uploads/2021/03/New_Token_Button3-1.png" alt="" class="wp-image-53"/></figure>



<p>A Window should pop up allowing you to name the purpose of the token, and when you wish for the token to expire. You can name the purpose anything you would like, and you can have the token never expire by leaving the &#8220;Expires&#8221; field blank.</p>



<figure class="wp-block-gallery columns-1 is-cropped"><ul class="blocks-gallery-grid"><li class="blocks-gallery-item"><figure><img loading="lazy" width="602" height="316" src="../ws/wordpress/wp-content/uploads/2021/03/Create_Token.png" alt="" data-id="54" data-full-url="../ws/wordpress/wp-content/uploads/2021/03/Create_Token.png" data-link="../ws/wordpress/about-2/create_token/" class="wp-image-54" srcset="../ws/wordpress/wp-content/uploads/2021/03/Create_Token.png 602w, ../ws/wordpress/wp-content/uploads/2021/03/Create_Token-300x157.png 300w" sizes="(max-width: 602px) 100vw, 602px" /></figure></li></ul></figure>
	</div><!-- .entry-content -->
